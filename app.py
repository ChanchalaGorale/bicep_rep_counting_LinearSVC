...
class App:
    ...
    def init_gui(self):
        ...
        self.class_one = tk.Button(self.window, text="Extended", width=50, command=lambda : self.save_for_class(1))
        self.class_one.pack(anchor=tk.CENTER, expand=True)

        self.class_two = tk.Button(self.window, text="Contracted", width=50, command=lambda : self.save_for_class(2))
        self.class_two.pack(anchor=tk.CENTER, expand=True)
    ...
    def save_for_class(self, class_num):
        ...
        img.thumbnail((150, 150), PIL.Image.ANTILALIAS)
